[
  {
    ...
    '$unset': [
      'roles', 'password', 'registrationYears', 'registration', 'yearRoles', 'family.year', 'family.parent'
    ]
  }, {
    '$lookup': {
      'from': 'children', 
    ...
    '$set': {
      'costClasses.1': {
        '$multiply': [
          '$course.classFee', '$class.semesterSessions.1'
        ]
      }, 
      'costMaterials.1': '$course.semesterMaterialsFee.1', 
      'costClasses.2': {
        '$multiply': [
          '$course.classFee', '$class.semesterSessions.2'
        ]
      }, 
